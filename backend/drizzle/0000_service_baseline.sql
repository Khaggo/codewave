...
CREATE TYPE "public"."earning_rule_accrual_source" AS ENUM('service');--> statement-breakpoint
...
CREATE TYPE "public"."loyalty_source_type" AS ENUM('service_payment', 'service_invoice', 'reward_redemption', 'manual_adjustment', 'service_reversal');--> statement-breakpoint
...
CREATE INDEX "vehicles_user_created_id_idx" ON "vehicles" USING btree ("user_id","created_at","id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "insurance_inquiries_user_client_request_idx" ON "insurance_inquiries" USING btree ("user_id","client_request_id");--> statement-breakpoint
...
CREATE INDEX "staff_work_claims_active_owner_queue_idx" ON "staff_work_claims" USING btree ("queue_type","owner_user_id","status");--> statement-breakpoint
