import { formatWorkflowLabel } from './insuranceInquiryPresentationModel.mjs'
import { formatMissingDocumentLabels } from './insuranceDocumentView.mjs'

export {
  buildRequirementsChecklist,
  createPickedInsuranceDocumentDraft,
} from './insuranceDocumentView.mjs'
...
export const buildCustomerInsuranceStatusState = ({
  ...
  if (!latestInquiry) {
    return {
      ...
      ctaRouteKey: INSURANCE_MODE_SECTION_KEYS.request,
