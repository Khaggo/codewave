...
description: Automatically chain MCP session bootstrap and the Swagger-plus-Serena workflow before executing repo work. Use when the user says continue, do the next task, investigate a module, or otherwise wants implementation work without re-deciding which MCPs to use first.
---
