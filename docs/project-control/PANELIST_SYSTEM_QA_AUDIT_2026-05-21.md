...
| Loyalty qualification standards. | Partial | Loyalty service tests passed for paid-service accrual and inactive/missing rule behavior. Standards need UI/paper explanation. | Medium | Document earning rules and add admin/customer demo proof. |
